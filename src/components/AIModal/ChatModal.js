...
//           setAwaitingItemInput(false); // awaitItemInput 상태를 false로 변경
//         }
...
//     if (messageText === "예산에 맞는 메뉴를 추천해 줘") {
//       setBudgetModalOpen(true);
//       return;
//     }

//     if (messageText === "장바구니에 물건을 담고 싶어") {
//       setMessages((prevMessages) => [
//         ...prevMessages,
//         {
...
//       }, 500);
//     } else if (
//       message.text === "ex)장바구니에 물건을 담고 싶어" ||
//       "장바구니에 물건을 담고 싶어"
//     ) {
//       setMessages((prevMessages) => [
//         ...prevMessages,
...
const ChatModal = ({ open, onClose, cart, totalAmount, setCart }) => {
  ...
  const {
    ...
    (speechResult) => {
      const finalMessage = awaitingItemInput ? speechResult : speechResult;
      setNewMessage(finalMessage);
      handleSendMessage(finalMessage);
    },
    (event) => {
